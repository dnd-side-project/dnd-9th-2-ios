...
enum AlertCreateMeetingType: Equatable {
    ...
    case limitMeetingCount // 모임 개수 초과
...
extension AlertCreateMeetingType: AlertType {
    ...
    var title: String {
        ...
        case .limitMeetingCount: return "하루 약속 개수 초과"
    ...
    var description: String {
        ...
        case .limitMeetingCount: return "하루에 최대 2개 생성할 수 있어요"
    ...
    var buttonTitle: String {
        ...
        case .limitMeetingCount: return "홈으로"
        case .networkError: return "확인"
        case .userError: return "재로그인"
        case .requestModelError: return "홈으로"
        }
    }
}
